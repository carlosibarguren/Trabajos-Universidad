...
def crear_interfaz():
    ...
    global root, frame_resultados, entry_prob_compra, entry_prob_repara, entry_prob_retira, entry_cliente_desde, entry_cliente_hasta, entry_venta_desde, entry_venta_hasta, entry_reparar_desde, entry_reparar_hasta, entry_prob_cafe, entry_demora_cafe, entry_tiempo_simular, entry_a, entry_b, scrollbar_x
    root = tk.Tk()
    ...
    tk.Label(root, text="Mostrar desde:").place(x=920, y=110)
    entry_a = tk.Entry(root, width=10, justify='center')
    entry_a.place(x=1030, y=110)

    tk.Label(root, text="Cantidad Filas:").place(x=920, y=140)
    entry_b = tk.Entry(root, width=10, justify='center')
    entry_b.place(x=1030, y=140)
...
def simular():
    ...
    global muestro_fila, cliente_inicial_fila1
...
def crear_fila_en_tabla(fila):
    ...
    columnas_fijas = ["fila", "reloj", "evento", "proximo_evento", "random_llegada", "tiempo_entre_llegadas",
                      ...
                      "fin_atencion", "random_reparacion", "tiempo_reparacion", "fin_reparacion", "random_cafe",
                      "toma_cafe", "fin_cafe", "ayudante_estado", "cola_ayudante", "relojero_estado",
                      "cola_relojes_reparar", "cola_relojes_reparados", "clientes_atendidos", "clientes_no_reparados",
                      "tiempo_ocupado_ayudante", "tiempo_ocupado_relojero"]
...
def crear_encabezado_superior():
    ...
    nombres_columnas = [
        "Fila", "Reloj", "Evento", "Próximo Evento", "Random Llegada", "Tiempo entre Llegadas",
        "Próxima Llegada", "Random Necesidad", "Necesidad Cliente", "Random Venta", "Tiempo Atención",
        "Fin Atención", "Random Reparación", "Tiempo Reparación", "Fin Reparación", "Random Café",
        "Toma Café", "Fin Café", "Ayudante Estado", "Cola Ayudante", "Relojero Estado",
        "Cola Relojes Reparar", "Cola Relojes Reparados", "Clientes Atendidos", "Clientes No Reparados",
        "Tiempo Ocupado Ayudante", "Tiempo Ocupado Relojero"
    ]
